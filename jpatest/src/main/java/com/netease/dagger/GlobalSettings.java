...
public class GlobalSettings {
	//private static String resPath = Class.class.getClass().getResource("/").getPath();
...
//	public static String chromeDriverPath = "/Users/chenDoInG/Downloads/chromedriver_for_mac_64";
	...
	public static String rootUrl = prop.getProperty("rootUrl", "http://www.baidu.com/");
	...
	public static Properties getProperties() {
		...
		try {
			...
			InputStream file = GlobalSettings.class.getResourceAsStream("/prop.properties");
			prop.load(file);
			file.close();
		} catch (Exception e) {
			e.printStackTrace();
