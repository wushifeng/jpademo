...
;(function ($, window, document, undefined) {
    ...
    var Tree = function (element, options) {
        ...
        return {
            ...
            delChildrenNode: $.proxy(this.delChildrenNode, this),
            // Get methods
     ...
     * 删除当前父节点的所有子节点
     */
    Tree.prototype.delChildrenNode = function (identifiers, options) {
        this.forEachIdentifier(identifiers, options, $.proxy(function (node, options) {
            this.setdelChildrenNode(node);
        }, this));
     ...
     *  删除当前父节点的所有子节点
     */
    Tree.prototype.setdelChildrenNode = function (node) {
        node.nodes = [];
    };
